...
export type GetCompanyProfileAggregateType<T extends CompanyProfileAggregateArgs> = {
    [P in keyof T & keyof AggregateCompanyProfile]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateCompanyProfile[P]> : Prisma.GetScalarType<T[P], AggregateCompanyProfile[P]>;
};
...
type GetCompanyProfileGroupByPayload<T extends CompanyProfileGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<CompanyProfileGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof CompanyProfileGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], CompanyProfileGroupByOutputType[P]> : Prisma.GetScalarType<T[P], CompanyProfileGroupByOutputType[P]>;
}>>;
export type CompanyProfileWhereInput = {
    ...
    companyEmail?: Prisma.StringFilter<"CompanyProfile"> | string;
    companyLogoUrl?: Prisma.StringNullableFilter<"CompanyProfile"> | string | null;
...
export type CompanyProfileScalarWhereWithAggregatesInput = {
    ...
    companyEmail?: Prisma.StringWithAggregatesFilter<"CompanyProfile"> | string;
    companyLogoUrl?: Prisma.StringNullableWithAggregatesFilter<"CompanyProfile"> | string | null;
...
export type CompanyProfileOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "companyName" | "companyEmail" | "companyLogoUrl" | "createdAt" | "updatedAt", ExtArgs["result"]["companyProfile"]>;
...
export type CompanyProfileCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<CompanyProfileFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CompanyProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends CompanyProfileCountArgs>(args?: Prisma.Subset<T, CompanyProfileCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], CompanyProfileCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends CompanyProfileGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, CompanyProfileGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCompanyProfileGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface CompanyProfileFieldRefs {
    ...
    readonly companyEmail: Prisma.FieldRef<"CompanyProfile", 'String'>;
    readonly companyLogoUrl: Prisma.FieldRef<"CompanyProfile", 'String'>;
